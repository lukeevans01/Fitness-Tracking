...
def _build_prompt() -> str:
    return _PROMPT_TEMPLATE.format(
        shared_profile=coach_orchestrator._SHARED_PROFILE,
...
def main():
    ...
    plan["_comment"] = (
        "Luke's fitness plan. 7-day weekly cycle (Day 1 = Monday). "
    ...
    plan["phase1_cycle_length_days"] = 7
    plan["phase1_days"] = days
